...
names1 = ["mug_on_rack_relation", "bowl_on_mug_relation", "bottle_in_container_relation"]
names2 = ["mug_place", "bowl_place", "bottle_place"]
indices = [[0, 1, 2, 4, 6, 7, 8, 9], list(range(10)), [0, 1, 2, 3, 4, 6, 7, 8, 9, 10, 11]]

names1 = ["bowl_on_mug_relation"]
names2 = ["bowl_place"]
indices = [list(range(10))]

for name1, name2, rndf_indices in zip(names1, names2, indices):
